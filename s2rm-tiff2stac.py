...
PRODUCTS = ['b01',"b02","b03","b04","b05","b06","b07","b08","b8a","b11","b12",'medoid_mos',
 'quality_aot','quality_cloud_confidence','quality_scene_classification','quality_snow_confidence',
    'source_index','sun_azimuth','sun_zenith','valid_obs','view_azimuth_mean','view_zenith_mean']
#["ndvi", "ndbi", "ndti", "ndsi", "ndmi"]
#
